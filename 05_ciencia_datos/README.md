# Nivel 5: Ciencia de Datos con Pandas

Pandas es la herramienta esencial para la manipulación y análisis de datos estructurados en Python. Este módulo cubre desde la carga de datos hasta la limpieza avanzada y transformación.
...
2.  **[Limpieza y Transformación (ETL)](./02_limpieza_transformacion.ipynb)**
    ...
    *   Fusión de datasets (`merge`, `concat`).
