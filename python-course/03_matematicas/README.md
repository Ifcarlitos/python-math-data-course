# Nivel 3: Matemáticas Computacionales

En este módulo profundizaremos en la aplicación de Python para resolver problemas matemáticos complejos, utilizando las potentes librerías `scipy` y `sympy`.
...
3.  **[Métodos Numéricos](./03_metodos_numericos.ipynb)**
    *   Búsqueda de raíces.
